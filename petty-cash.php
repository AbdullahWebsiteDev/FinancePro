...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-800 mb-2">Petty Cash Management</h1>
    <p class="text-gray-600">Add and manage your petty cash records</p>
</div>

<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
    <!-- Add Petty Cash Form -->
    <div class="bg-white rounded-lg shadow-md p-6 lg:col-span-1">
        <h2 class="text-lg font-semibold text-gray-800 mb-4">Add New Petty Cash</h2>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 lg:col-span-2">
        <h2 class="text-lg font-semibold text-gray-800 mb-4">Petty Cash Records</h2>
        ...
        <?php if (count($pettyCash) > 0): ?>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="pettyCashTableBody">
        ...
        <?php else: ?>
            <div class="text-center py-8">
                <p class="text-gray-500 text-lg">No petty cash records found</p>
                <p class="text-gray-400 text-sm mt-1">Add your first petty cash using the form</p>
            </div>
        <?php endif; ?>
    </div>
</div>
