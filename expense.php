...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-800 mb-2">Expense Management</h1>
    <p class="text-gray-600">Add, edit, and manage your expenses</p>
</div>
...
<div id="editExpenseModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        ...
        <form id="editExpenseForm" class="space-y-4">
            ...
            <div>
                <label for="editItem" class="block text-sm font-medium text-gray-700 mb-1">Item</label>
                <input type="text" id="editItem" name="item" required placeholder="Expense item or description"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            
            <div>
                <label for="editCost" class="block text-sm font-medium text-gray-700 mb-1">Cost</label>
                <div class="relative mt-1 rounded-md shadow-sm">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <span class="text-gray-500 sm:text-sm">$</span>
                    </div>
...
<div id="deleteConfirmModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        <div class="mb-4">
            ...
            <p class="text-gray-600 mt-2">Are you sure you want to delete this expense? This action cannot be undone.</p>
        </div>
